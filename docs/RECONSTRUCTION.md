...
- mandate text, benchmark, target/actual mix, liquidity, settlement (T+0 / T+1 / T+2 / T+3 / Restricted / Closed), GENIUS reserve screen computed from holdings WAM (Yes / Partial / No), minimum, distributions
- top holdings
...
| `/funds` | Filterable table (search, vehicle, mandate style, liquidity, GENIUS reserve, sort) |
